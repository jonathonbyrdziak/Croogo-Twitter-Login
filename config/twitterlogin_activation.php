 ...
 */
	public function onActivation(&$controller) {
		...
		$controller->Croogo->addAco('Twitterlogin/tweetit', array('registered', 'public')); // TwitterloginController::index()
		$controller->Croogo->addAco('Twitterlogin/favorite', array('registered', 'public')); // TwitterloginController::index()
